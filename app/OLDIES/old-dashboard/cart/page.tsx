...
import { useAppInfo } from '../../../old-components/Context-Provaiders/AppProvider';
import CartList from '../../../old-components/Marketplace/CartList';
  ...
  async () => {
    ...
    async function fetchProducts() {
      ...
      for (let index = 0; index < productIDArr.length; index++) {
        ...
        arr.push({
          ...singleProduct,
          count: cartProducts[productIDArr[index]],
        });
      }
