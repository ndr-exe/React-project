...
import AddUserBtn from '../../../old-components/Users/AddUserBtn';
import DeleteUser from '../../../old-components/Users/DeleteUser';
import UpdateUserBtn from '../../../old-components/Users/UpdateUserBtn';
        ...
        <table className="border-spacing-6 w-full">
          <tbody className="pt-3">
            <tr className="border-b border-b-gray-600/80">
              <th className="font-semibold text-gray-600 text-left py-2 w-[75px]">
                ID
              </th>
              <th className="font-semibold text-gray-600 text-left py-2 ">
                User
              </th>
              <th className="font-semibold text-gray-600 text-left py-2 ">
                Email
              </th>
              <th className="font-semibold text-gray-600 text-center py-2 ">
                Age
              </th>
              <th></th>
              <th></th>
            ...
            {users.map((user: User) => {
              return (
                <tr
                  className="border-b border-gray-500/40 pt-3 hover:bg-gray-700/15"
                  key={user.id}
                >
