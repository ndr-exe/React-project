...
export default function SlideInfo({ heading, details }: { heading: string; details: string }) {
  return (
    <div
    ...
    >
      <div className="flex flex-col items-center gap-3 xl:gap-5 text-sm lg:items-start lg:w-[450px] lg:text-lg xl:text-2xl ">
        <div className="w-[80px] h-[80px] rounded-full flex justify-center items-center relative ">
          <Image src={logo} alt="logo" fill className="ml-3" />
        </div>
