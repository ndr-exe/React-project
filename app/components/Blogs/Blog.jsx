...
export default function Blog({title,uploadDate,body,important,image,id}) {
         if(important) return (
             <li className="col-span-8 h-full rounded-md overflow-hidden hover:bg-gray-200 ">
                 ...
                 <div className='px-6 pt-5 border border-t-0 border-blue-950 rounded-b-md flex flex-col justify-between h-full '>
                     ...
                     <br/>
                    <Link href={`blog/${id}`}>
                        <span className='text-orange-600 hover:text-gray-800' href="/">Read More...</span>
                     </Link>
                     </p>
         ...
         return (
             <li className="col-span-4 h-full rounded-md overflow-hidden hover:bg-gray-200">
             <article className='w-full h-full flex flex-col'> 
